-- ClubOS-Final local seed.
-- This file intentionally contains reference/default data only, not demo club,
-- player, parent, staff, roster, match, or tournament records.
-- The same data is versioned in the seed migration so production stays aligned.
